    ...
    <div class="all-course-main">
      <div class="allcourse-content">
        <div class="courseitem">
          <div class="img-box">
            <a href=""><img alt="3天javascript入门到进阶" src="/src/assets/course-9.png" /> </a>
          </div>
          <div class="info-box">
            <div class="title">
              <span>免费课</span>
...
因为前面我们把课程与用户的关系模型UserCourse声明在了user/models.py下， 所以现在代码跟着模型走，为方便代码管理，当前我的课程功能也一并写在当前子应用user下。
...
![image-20210812094549451](https://img2023.cnblogs.com/blog/2570053/202304/2570053-20230411215843096-1298164256.png)
...
![image-20230415094458810](https://img2023.cnblogs.com/blog/2570053/202304/2570053-20230415094501642-503623992.png)

选择云点播，就可以上传视频到保利威，也可以下载保利威的界面软件上传视频。(需要认证一下)

![image-20230415094524527](https://img2023.cnblogs.com/blog/2570053/202304/2570053-20230415094525676-1287539541.png)

要开发播放保利威的加密视频开发功能，需要在设置->API接口和加密设置。

![image-20230415095010023](https://img2023.cnblogs.com/blog/2570053/202304/2570053-20230415095011371-421342042.png)
...
![image-20230415095202128](https://img2023.cnblogs.com/blog/2570053/202304/2570053-20230415095204209-494788804.png)

经过上面的设置，上传的视频就会自动加密

![image-20230415100307449](https://img2023.cnblogs.com/blog/2570053/202304/2570053-20230415100308801-1597605713.png)

接着我们只需要记录视频的VID保存在项目的对应的课时记录表中即可。

![image-20230415101308745](https://img2023.cnblogs.com/blog/2570053/202304/2570053-20230415101310053-993230252.png)

手动把刚刚上面上传的视频的VID填写course_lesson课时记录表里面。

![image-20230415102328455](https://img2023.cnblogs.com/blog/2570053/202304/2570053-20230415102329708-65405443.png)
...
~~~python
feature: 服务端提供保利威视频获取token接口，并在course_lesson表中配置视频的vid
~~~
...
从当前地址下载播放器js核心文件保存到客户端`src/utils`目录下：http://player.polyv.net/script/player.js
...
`course/seriazlier.py`，新增`get_chapter_list`
...
`course/models.py`，`course`模型表新增`get_chapter_list`
...
~~~python
feature: 客户端获取课程信息和课程学习进度并调整后台模型表
~~~
