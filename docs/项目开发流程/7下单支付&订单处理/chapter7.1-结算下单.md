...
git tag v0.0.4 -m "购物车功能完成，订单生成之前"
# 提交标签版本
git push --tag
...
```bash
feature：订单子应用创建以及订单信息和订单项模型的创建
```
...
```bash
feature：把订单子应用相关的模型注册到admin管理站点
```
